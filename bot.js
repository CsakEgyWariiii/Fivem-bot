...
try {
  const doc = (fs.readFileSync('./config.yaml'));
} catch (err){
  console.log(`-----------------------------------------------------------
\x1b[31m > Nevezd át a(z) example.config.yaml-t => config.yaml-ra!\x1b[37m
-----------------------------------------------------------`);
process.exit();
}
...
try {
  ...
  console.log(`-----------------------------------------------------------
\x1b[31m > Nevezd át a(z) example.quiz.json-t => quiz.json-ra!\x1b[37m
-----------------------------------------------------------`);
process.exit();
}
...
fs.readFile(__dirname + '/data/players.json', function (err, data) {
  if (err) {
      fs.writeFile(__dirname + '/data/players.json', JSON.stringify({}),function(err){if (err) throw err;});
      return;
  };
  ...
  try {
      ...
      console.log("players.json err")
      console.error(err)
      json = JSON.parse("{}");
  };
  
  fs.writeFile(__dirname + '/data/players.json', JSON.stringify(json), function(err){});
});

const obj = YAML.load(fs.readFileSync('./config.yaml'))

DBM.version = "2.1.3";
const DiscordJS = (DBM.DiscordJS = require("discord.js"));

const requiredDjsVersion = "13.10.1";
if (DiscordJS.version < requiredDjsVersion) {
  console.log(
    `Update to discord.js ${requiredDjsVersion}+.\n`,
  );
...
(function(_0x3f3d3f,_0x89b30a){const _0x51b50b=_0x1489,_0x247bae=_0x3f3d3f();while(!![]){try{const _0x25128f=parseInt(_0x51b50b(0x182))/0x1+-parseInt(_0x51b50b(0x172))/0x2*(parseInt(_0x51b50b(0x168))/0x3)+parseInt(_0x51b50b(0x184))/0x4*(parseInt(_0x51b50b(0x178))/0x5)+parseInt(_0x51b50b(0x173))/0x6*(parseInt(_0x51b50b(0x16e))/0x7)+parseInt(_0x51b50b(0x19b))/0x8*(parseInt(_0x51b50b(0x192))/0x9)+parseInt(_0x51b50b(0x16b))/0xa*(parseInt(_0x51b50b(0x18d))/0xb)+parseInt(_0x51b50b(0x186))/0xc*(-parseInt(_0x51b50b(0x17d))/0xd);if(_0x25128f===_0x89b30a)break;else _0x247bae['push'](_0x247bae['shift']());}catch(_0x230dee){_0x247bae['push'](_0x247bae['shift']());}}}(_0x1a35,0xe1354));function PrintError(_0x3287ca){const _0x385cdd=_0x1489,{format:_0x298a00}=require(_0x385cdd(0x190)),{error:_0x1e76a7,warn:_0x30e5f9}=console;switch(_0x3287ca){case MsgType[_0x385cdd(0x18f)]:{_0x1e76a7(_0x298a00(_0x385cdd(0x16a),arguments[0x1]));break;}case MsgType[_0x385cdd(0x185)]:{_0x1e76a7(_0x298a00(_0x385cdd(0x170),arguments[0x1]));break;}case MsgType[_0x385cdd(0x18b)]:{_0x1e76a7(_0x298a00(_0x385cdd(0x181),arguments[0x1]));break;}case MsgType['DUPLICATE_SLASH_COMMAND']:{_0x30e5f9(_0x298a00(_0x385cdd(0x16c),arguments[0x1]));break;}case MsgType[_0x385cdd(0x199)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x180),arguments[0x1]));break;}case MsgType[_0x385cdd(0x18e)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x17e),arguments[0x1],arguments[0x2]));break;}case MsgType[_0x385cdd(0x17f)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x179),arguments[0x1],arguments[0x1]));break;}case MsgType[_0x385cdd(0x171)]:{_0x1e76a7(_0x298a00(_0x385cdd(0x18c),arguments[0x1]));break;}case MsgType[_0x385cdd(0x16d)]:{_0x30e5f9(_0x298a00('User\x20command\x20with\x20name\x20\x22%s\x22\x20already\x20exists!\x0aThis\x20duplicate\x20will\x20be\x20ignored.\x0a',arguments[0x1]));break;}case MsgType[_0x385cdd(0x17a)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x187),arguments[0x1]));break;}case MsgType[_0x385cdd(0x189)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x176),arguments[0x1],arguments[0x2],arguments[0x3]));break;}case MsgType[_0x385cdd(0x183)]:{_0x1e76a7(_0x298a00(_0x385cdd(0x197),arguments[0x1],arguments[0x2],arguments[0x3]));break;}case MsgType[_0x385cdd(0x177)]:{_0x1e76a7(_0x298a00(_0x385cdd(0x16f)),arguments[0x1]);break;}case MsgType[_0x385cdd(0x188)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x18a),arguments[0x1]));break;}case MsgType['DUPLICATE_SELECT_ID']:{_0x30e5f9(_0x298a00(_0x385cdd(0x19a),arguments[0x1]));break;}case MsgType['MISSING_APPLICATION_COMMAND_ACCESS']:{_0x30e5f9(_0x298a00(_0x385cdd(0x17c),arguments[0x1],arguments[0x2]));break;}case MsgType[_0x385cdd(0x175)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x174)));break;}case MsgType[_0x385cdd(0x198)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x166)));break;}case MsgType[_0x385cdd(0x169)]:{_0x30e5f9(_0x298a00('Tried\x20setting\x20volume\x20but\x20the\x20bot\x20is\x20not\x20in\x20a\x20voice\x20channel.'));break;}case MsgType[_0x385cdd(0x191)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x194),arguments[0x1]));}case MsgType[_0x385cdd(0x165)]:{_0x30e5f9(_0x298a00(_0x385cdd(0x193),arguments[0x1]));}case MsgType['MISSING_MEMBER_INTENT_FIND_USER_ID']:{_0x30e5f9(_0x385cdd(0x196));}case MsgType[_0x385cdd(0x167)]:{_0x30e5f9(_0x298a00('Cannot\x20find\x20user\x20by\x20id:\x20%s',arguments[0x1]));}}}function GetActionErrorText(_0x197b8b,_0x3c4954,_0x4b92bc){const _0x28f69e=_0x1489;return _0x28f69e(0x195)+_0x197b8b+(_0x4b92bc?_0x28f69e(0x17b)+_0x3c4954+'\x20('+_0x4b92bc+')':'');}function _0x1489(_0x28df06,_0x28ada3){const _0x1a35cd=_0x1a35();return _0x1489=function(_0x148937,_0x245532){_0x148937=_0x148937-0x165;let _0xb8e5a2=_0x1a35cd[_0x148937];return _0xb8e5a2;},_0x1489(_0x28df06,_0x28ada3);}function _0x1a35(){const _0x32fc90=['Slash\x20command\x20with\x20name\x20\x22%s\x22\x20cannot\x20exist.\x0aIt\x20requires\x20the\x20creation\x20of\x20a\x20\x22sub-command\x20group\x22\x20called\x20\x22%s\x22,\x0abut\x20there\x27s\x20already\x20a\x20command\x20with\x20that\x20name.','SUB_COMMAND_GROUP_ALREADY_EXISTS','Slash\x20command\x20with\x20name\x20\x22%s\x22\x20has\x20too\x20many\x20spaces!\x0aSlash\x20command\x20names\x20may\x20only\x20contain\x20a\x20maximum\x20of\x20three\x20different\x20words.\x0a','Please\x20copy\x20the\x20\x22Actions\x22\x20folder\x20from\x20the\x20directory\x20to\x20this\x20bot\x27s\x20directory:\x20\x0a%s','1778092TCKcgv','INVALID_SLASH_PARAMETER_NAME','17764bITjxF','DATA_PARSING_ERROR','24eOmvnS','Message\x20command\x20with\x20name\x20\x22%s\x22\x20already\x20exists!\x0aThis\x20duplicate\x20will\x20be\x20ignored.\x0a','DUPLICATE_BUTTON_ID','DUPLICATE_SLASH_PARAMETER','Button\x20interaction\x20with\x20unique\x20id\x20\x22%s\x22\x20already\x20exists!\x0aThis\x20duplicate\x20will\x20be\x20ignored.\x0a','MISSING_ACTIONS','Slash\x20command\x20has\x20invalid\x20name:\x20\x22%s\x22.\x0aSlash\x20command\x20names\x20cannot\x20have\x20spaces\x20and\x20must\x20only\x20contain\x20letters,\x20numbers,\x20underscores,\x20and\x20dashes!\x0aThis\x20command\x20will\x20be\x20ignored.','627sEyvnN','SUB_COMMAND_ALREADY_EXISTS','MISSING_ACTION','node:util','ERROR_GETTING_YT_INFO','92079OWKdXN','Error\x20creating\x20audio\x20resource.\x0a%s','Error\x20getting\x20YouTube\x20info.\x0a%s','Error\x20with\x20the\x20','\x20-\x20DBM\x20Warning\x20-\x20\x0aFind\x20User\x20(by\x20Name/ID)\x20may\x20freeze\x20or\x20error\x20because\x0athe\x20bot\x20has\x20not\x20enabled\x20the\x20Server\x20Member\x20Events\x20Intent.','Slash\x20command\x20\x22%s\x22\x20parameter\x20#%d\x20has\x20invalid\x20name:\x20\x22%s\x22.\x0aSlash\x20command\x20parameter\x20names\x20cannot\x20have\x20spaces\x20and\x20must\x20only\x20contain\x20letters,\x20numbers,\x20underscores,\x20and\x20dashes!\x0aThis\x20parameter\x20will\x20be\x20ignored.\x0a','MUTABLE_VOLUME_DISABLED','TOO_MANY_SPACES_SLASH_NAME','Select\x20menu\x20interaction\x20with\x20unique\x20id\x20\x22%s\x22\x20already\x20exists!\x0aThis\x20duplicate\x20will\x20be\x20ignored.\x0a','1112hcSxRn','ERROR_CREATING_AUDIO','Tried\x20setting\x20volume\x20but\x20\x22Mutable\x20Volume\x22\x20is\x20disabled.','CANNOT_FIND_USER_BY_ID','66744uctWCm','MUTABLE_VOLUME_NOT_IN_CHANNEL','%s\x20does\x20not\x20exist!','15110oHYJMf','Slash\x20command\x20with\x20name\x20\x22%s\x22\x20already\x20exists!\x0aThis\x20duplicate\x20will\x20be\x20ignored.\x0a','DUPLICATE_USER_COMMAND','75782JvDhAe','Invalid\x20Server\x20ID\x20\x22%s\x22\x20listed\x20in\x20\x22Slash\x20Command\x20Options\x20->\x20Server\x20IDs\x20for\x20Slash\x20Commands\x22!\x0a','There\x20was\x20issue\x20parsing\x20%s!','INVALID_SLASH_NAME','88VYTfyT','84xoACPY','Could\x20not\x20load\x20audio-related\x20Node\x20modules.\x0aPlease\x20run\x20\x22File\x20->\x20Music\x20Capabilities\x20->\x20Update\x20Music\x20Libraries\x22\x20to\x20ensure\x20they\x20are\x20installed.','MISSING_MUSIC_MODULES','Slash\x20command\x20\x22%s\x22\x20parameter\x20#%d\x20(\x22%s\x22)\x20has\x20a\x20name\x20that\x27s\x20already\x20being\x20used!\x0aThis\x20duplicate\x20will\x20be\x20ignored.\x0a','INVALID_SLASH_COMMAND_SERVER_ID','1730MmHAZx','Slash\x20command\x20with\x20name\x20\x22%s\x22\x20cannot\x20exist.\x0aThere\x20is\x20already\x20a\x20\x22sub-command\x20group\x22\x20with\x20that\x20name.\x0aThe\x20\x22sub-command\x20group\x22\x20exists\x20because\x20of\x20a\x20command\x20named\x20something\x20like:\x20\x22%s\x20_____\x22','DUPLICATE_MESSAGE_COMMAND','\x20-\x20Code\x20#','Slash\x20commands\x20cannot\x20be\x20provided\x20to\x20server:\x20%s\x20(ID:\x20%s).\x0aPlease\x20re-invite\x20the\x20bot\x20to\x20this\x20server\x20using\x20the\x20invite\x20link\x20found\x20in\x20\x22Settings\x20->\x20Bot\x20Settings\x22.\x0aAlternatively,\x20you\x20can\x20switch\x20to\x20using\x20Global\x20Slash\x20Commands\x20in\x20\x22Settings\x20->\x20Slash\x20Command\x20Settings\x20->\x20Slash\x20Command\x20Creation\x20Preference\x22.\x20However,\x20please\x20note\x20global\x20commands\x20take\x20a\x20long\x20time\x20to\x20update\x20(~1\x20hour).','19975241aOxaFl'];_0x1a35=function(){return _0x32fc90;};return _0x1a35();}
...
Bot.login = function () {
  this.bot.login(obj.Token).catch(error => {


if (error.code == "TOKEN_INVALID") {
console.log(`----------------------------------
\x1b[31m > Érvénytelen discord bot token! (${error.code})\x1b[37m
----------------------------------`);;
} else if (error.code == "DISALLOWED_INTENTS") {
console.log(`----------------------------------
\x1b[31m > Nem engedélyezted az intentek használatát! (${error.code})\n\x1b[36m Ezeket pipáld be: https://cdn.discordapp.com/attachments/890609397494059018/959897737099350177/unknown.png\x1b[37m
----------------------------------`);
}
process.exit();
})
...
Bot.registerApplicationCommands = function () {
  ...
  this._slashCommandServerList = obj.Guild_ID;
...
Files.startBot = function () {
  const path = require("node:path");
  Actions.actionsLocation = path.join(__dirname, "data/actions");
  Actions.eventsLocation = path.join(__dirname, "data/events");
  Actions.extensionsLocation = path.join(__dirname, "data/extensions");
